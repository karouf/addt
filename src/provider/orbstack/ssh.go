...
func (p *OrbStackProvider) HandleSSHForwarding(forwardKeys bool, forwardMode, sshDir, username string, allowedKeys []string) []string {
	if !forwardKeys {
		return nil
	}
...
func (p *OrbStackProvider) mountSafeSSHFiles(sshDir, username string) []string {
	var args []string

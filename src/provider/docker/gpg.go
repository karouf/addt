...
func (p *DockerProvider) handleGPGProxyForwardingTCP(agentSocket, gpgDir, username string, allowedKeyIDs []string) []string {
	var args []string
...
func (p *DockerProvider) mountSafeGPGFilesWritable(gpgDir, username string) []string {
	var args []string
